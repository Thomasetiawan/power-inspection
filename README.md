# 🚀 power-inspection - Simple Tool for Power Analysis
...
- **User-Friendly Interface:** Navigate easily even without technical expertise.
- **Real-Time Monitoring:** View power quality in real time to spot issues instantly.
- **Data Logging:** Automatically saves data for later review.
- **Customizable Alerts:** Set alerts for parameters that matter to you.
- **Compatible with Windows and Mac:** Use on popular operating systems.
...
- **Mac:**
  ...
  2. Drag the **power-inspection** icon into your "Applications" folder.
  3. Eject the installation file after it copies.

### Step 4: Launch the Application

After installation, find **power-inspection** in your applications list. Double-click the icon to open the application.

## 📊 Using the Application

1. **Connect Your Device:** Ensure your power monitoring device is connected.
2. **Start Monitoring:** Click on the "Start Monitoring" button on the main interface.
3. **View Data:** Use the dashboard to view real-time metrics such as voltage, current, and frequency.
4. **Generate Reports:** Click on "Reports" to generate historical data logs for your review.

## ⚙️ Troubleshooting

If you encounter any issues:

- **Check Compatibility:** Ensure you are using the correct version for your operating system.
- **Reinstall the App:** Sometimes uninstalling and reinstalling fixes problems.
- **Review the User Manual:** Access the user manual provided on the releases page for more detailed guidance.
